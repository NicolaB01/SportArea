...
class Cerca_disponibilita(QMainWindow):
    ...
    def refresh(self):
        ...
        for campo in campi:
            ...
            if campo.get_attività() not in allItems:
                self.comboBox_attivita.addItem(campo.get_attività())
    ...
    def cerca_disponibilita(self):
        ...
        try:
            Gestore_prenotazione.is_data_passata(data_attività)
